...
abstract: >
  ...
  LaTeX fragments as labels, annotations, and
  ...
  functions for more fine control over the separate authoring,
  typesetting, and rendering steps.
  ...
  can be positioned and sized relative to R graphics output and vice versa.
draft: true
author:  
  - name: Paul Murrell
...
These tools can be useful for generating larger chunks of `r LaTeX` code,
