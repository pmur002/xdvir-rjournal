...
The \CRANpkg{gridtext} \citep{pkg-gridtext} and \CRANpkg{ggtext} \citep{pkg-ggtext}
...
\begin{figure}
\includegraphics[width=1\linewidth]{typesetting-1} \caption{A plot with a text annotation that contains several typesetting challenges:  in-line mathematical equations; changes in color; and automated line-breaks with full justification and hyphenation.}\label{fig:typesetting}
\end{figure}
...
\includegraphics[width=0.4\linewidth]{unnamed-chunk-5-1}
...
\includegraphics[width=0.4\linewidth]{unnamed-chunk-7-1}
...
\includegraphics[width=0.4\linewidth]{unnamed-chunk-8-1}
...
\begin{figure}
\includegraphics[width=1\linewidth]{elementlatex-1} \caption{The \texttt{ggplot2} plot from Figure \ref{fig:typesetting}, without the text annotation, but with a title that was specified using a \LaTeX{} fragment and the function \texttt{element\_latex()}.}\label{fig:elementlatex}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{geomlatex-1} \caption{A \texttt{ggplot2} plot with text labels specified as \LaTeX{} fragments and drawn using the \texttt{geom\_latex()} function.}\label{fig:geomlatex}
\end{figure}
...
\begin{verbatim}
#> %% R package xdvir_0.1.2; engine name: XeTeX; engine version: XeTeX 3.14159265-2.6-0
...
#>              comment=R package xdvir_0.1.2; engine name: XeTeX; engine version: XeTe
...
\includegraphics[width=0.4\linewidth]{unnamed-chunk-19-1}
...
\includegraphics[width=0.4\linewidth]{unnamed-chunk-21-1}
...
\includegraphics[width=0.4\linewidth]{unnamed-chunk-27-1}
...
\includegraphics[width=0.4\linewidth]{unnamed-chunk-28-1}
...
\includegraphics[width=0.4\linewidth]{unnamed-chunk-29-1}
...
\includegraphics[width=0.4\linewidth]{unnamed-chunk-30-1}
...
\includegraphics[width=0.95\linewidth]{unnamed-chunk-32-1}
...
\includegraphics[width=0.95\linewidth]{unnamed-chunk-33-1}
...
\includegraphics[width=0.4\linewidth]{unnamed-chunk-35-1}
...
\includegraphics[width=0.4\linewidth]{unnamed-chunk-36-1}
...
\includegraphics[width=0.4\linewidth]{unnamed-chunk-37-1}
...
\includegraphics[width=0.4\linewidth]{unnamed-chunk-38-1}
...
\begin{figure}
\includegraphics[width=1\linewidth]{zref-1} \caption{The \texttt{ggplot2} plot from Figure \ref{fig:typesetting}, including the \LaTeX{} annotation, with a line added relative to marked locations within the \LaTeX{} annotation (and relative to the thick red line).}\label{fig:zref}
\end{figure}
...
\includegraphics[width=0.4\linewidth]{unnamed-chunk-40-1}
...
\includegraphics[width=0.4\linewidth]{unnamed-chunk-42-1}
...
\begin{figure}
\includegraphics[width=1\linewidth]{diag-1} \caption{The design of the `xdvir` package.}\label{fig:diag}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{rahlf-1} \caption{A plot with a two-column text annotation. This plot is an adaptation of Figure 4.1 from Thomas Rahlf's book ``Data Visualisation with R'' \citep{rahlf}.}\label{fig:rahlf}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{rahlfplain-1} \caption{The main plot from Figure \ref{fig:rahlf} without the two columns of text annotation. This plot is drawn using functions from the \texttt{graphics} package.}\label{fig:rahlfplain}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{schneider-1} \caption{A plot with annotated mathematical equation. This plot is an adaptation of the plot in \citet{schneider2023}.}\label{fig:schneider}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{schneiderplain-1} \caption{The main plot from Figure \ref{fig:schneider} without the annotated mathematical equation. This plot is produced using the packages \CRANpkg{ggplot2} and \CRANpkg{ggtext}.}\label{fig:schneiderplain}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{anzjs-1} \caption{A plot with numbered list items as annotations below the plot. This plot is an adaptation of Figure 10 from \citet{anzjs2025}.}\label{fig:anzjs}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{anzjsplain-1} \caption{The main plot from Figure \ref{fig:anzjs} without the numbered list items as annotations. This plot is produced using the \CRANpkg{ggplot2} package.}\label{fig:anzjsplain}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{lattice-1} \caption{A \CRANpkg{lattice} plot with \LaTeX{} text used for the plot title and for annotations in each panel.}\label{fig:lattice}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{latticeplain-1} \caption{The main plot from Figure \ref{fig:lattice} without the title and annotations in each panel. This plot is produced using the \CRANpkg{lattice} package.}\label{fig:latticeplain}
\end{figure}
...
\CRANpkg{directlabels} \citep{pkg:directlabels} and
