...
\hypertarget{programmatic-generation-of-latex}{%
\section{Programmatic generation of LaTeX}\label{programmatic-generation-of-latex}}
...
LaTeX code. For example, there are packages like \CRANpkg{xtable} (Dahl et al. 2019)
for generating LaTeX tables and the \CRANpkg{rmarkdown} package (Xie, Allaire, and Grolemund 2018)
...
Figure \ref{fig:lattice} of integrating \texttt{grid.latex()} output
...
It then calls \texttt{grid.latex()} to draw
