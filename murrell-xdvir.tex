...
\begin{verbatim}
#> %% R package xdvir_0.1.2; engine name: XeTeX; engine version: XeTeX 3.141592653-2.6-
...
\begin{figure}
\includegraphics[width=1\linewidth]{murrell-xdvir_files/figure-latex/schneider-1} \caption{A plot with annotated mathematical equation. This plot is an adaptation of the plot in \citet{schneider2023}.}\label{fig:schneider}
\end{figure}
