...
\begin{figure}
\includegraphics[width=1\linewidth]{murrell-xdvir_files/figure-latex/typesetting-1} \caption{A plot with a text annotation that contains several typesetting challenges:  in-line mathematical equations; changes in colour; and automated line-breaks with full justification and hyphenation.}\label{fig:typesetting}
\end{figure}
