...
\begin{figure}
\includegraphics[width=1\linewidth]{murrell-xdvir_files/figure-latex/anzjs-1} \caption{A plot with numbered list items as annotations below the plot. This plot is an adaptation of Figure 10 from Murrell (in press).}\label{fig:anzjs}
\end{figure}
...
Murrell, Paul. in press. {``Text in {R} Graphics.''} \emph{Australian \& New Zealand Journal of Statistics}, in press. https://doi.org/\url{https://doi.org/10.1111/anzs.12438}.

\leavevmode\vadjust pre{\hypertarget{ref-RJ-2015-012}{}}%
---------. 2015. {``The gridGraphics Package.''} \emph{The R Journal} 7: 151--62. \url{https://rjournal.github.io/}.
